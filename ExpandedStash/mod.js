...

{
  ...
  if (
    ...
    bankExpansionLayoutHD.fields &&
    bankExpansionLayoutHD.fields.backgroundFile
  ) {
    bankExpansionLayoutHD.fields.backgroundFile =
      bankExpansionLayoutHD.fields.backgroundFile.map((file) =>
        [
  ...
  processLayoutNode(bankExpansionLayoutHD);
