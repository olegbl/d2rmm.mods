...
['global\\excel\\monstats.txt', 'global\\excel\\base\\monstats.txt'].forEach(
  (monstatsFilename) => {
...
if (config.disableaffixes) {
  ...
  ['global\\excel\\monumod.txt', 'global\\excel\\base\\monumod.txt'].forEach(
    (monumodFilename) => {
  ...
  [
    ...
    'global\\excel\\base\\superuniques.txt',
  ].forEach((superuniquesFilename) => {
